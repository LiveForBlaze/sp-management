let config = {
  ...
  "urlName": "lagcoe", //uniq spm name for internal use f.e. for naming access-token
  "linkName": "lagcoe", // https://slidespiel.com/${linkName}/presentations
  "companyName": "LAGCOE 2019",
  "conferenceName": "", //optional. Leave empty if there is no need in specific conferenceName
  "primaryColor": "rgb(237,178,31)",
  "loaderColor": "rgb(237,178,31)",
